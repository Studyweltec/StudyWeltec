...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public static int Campuses = 1;
    public static int Student_speak_out = 2;
    ...
    public static int Auckland = 1;
    public static int Porirua = 2;
...
*/
        ...
        if (/*listPosition == ITEM1 || */listPosition == Campuses) {
            if (!isExpanded)
