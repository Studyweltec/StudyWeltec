...
public class AnimatedCircleLoadingView extends FrameLayout {
  ...
  private static final String DEFAULT_HEX_MAIN_COLOR = "#00c2ff";
  private static final String DEFAULT_HEX_SECONDARY_COLOR = "#BDBDBD";
  private static final String DEFAULT_HEX_TINT_COLOR = "#000000";
  private static final String DEFAULT_HEX_TEXT_COLOR = "#000000";
